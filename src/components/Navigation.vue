    ...
    <nav class="container">
      ...
      <div class="nav-links">
        <ul v-show="!mobile">
          ...
          <router-link v-if="user" class="link" :to="{ name: 'CreatePost' }">创建博客</router-link>
          <router-link v-if="!user" class="link" :to="{ name: 'Login' }">登录/注册</router-link>
        </ul>
        <div v-if="user" :class="{ 'mobile-user-menu': mobile }" @click="toggleProfileMenu" class="profile" ref="profile">
          <span class="">{{ this.$store.state.profileInitials }}</span>
          <div class="profile-menu" v-if="profileMenu">
            <div class="info">
              <p class="initials">{{ this.$store.state.profileInitials }}</p>
              <div class="right">
                <p>{{ this.$store.state.profileFirstName }} {{ this.$store.state.profileLastName }}</p>
                <p class="">{{ this.$store.state.profileUsername }}</p>
                <p class="">{{ this.$store.state.profileEmail }}</p>
              </div>
            </div>
            <div class="options">
              <div class="option">
